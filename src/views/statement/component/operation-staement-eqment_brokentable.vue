  ...
  <div>
    ...
    <div class="input">
      <el-row>
        ...
        <a href="http://127.0.0.1:8080/dbsql.jsp?mode=pdf&sql=289" target="_blank"><el-button type="primary">PDF--打印当前页</el-button></a>
        <a href="http://127.0.0.1:8080/dbsql.jsp?mode=excel&sql=289" target="_blank"><el-button type="primary">excel--打印当前页</el-button></a>
      </el-row>
    </div>
    <!--表格-->
    <el-table
